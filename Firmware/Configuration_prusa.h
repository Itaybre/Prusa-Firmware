...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,800,280}
...
#define HOMING_FEEDRATE {2200, 2200, 400, 0}  // set the homing speeds (mm/min) // 3000 is also valid for stallGuard homing. Valid range: 2200 - 3000
...
#define DEFAULT_ACCELERATION          800   // X, Y, Z and E max acceleration in mm/s^2 for printing moves (M204S)
#define DEFAULT_RETRACT_ACCELERATION  1250   // X, Y, Z and E max acceleration in mm/s^2 for retracts (M204T)

#define MANUAL_FEEDRATE {2200, 2200, 400, 100}   // set the speeds for manual moves (mm/min)
...
//Normal mode limits
#define NORMAL_MAX_ACCEL_XY     2200ul  // max acceleration in normal mode in mm/s^2
...
#define TMC2130_SG_THRS_E       2     // stallguard sensitivity for E axis

//new settings is possible for vsense = 1, running current value > 31 set vsense to zero and shift both currents by 1 bit right (Z axis only)
// #define TMC2130_CURRENTS_H {16, 20, 35, 30}  // default holding currents for all axes
// #define TMC2130_CURRENTS_R {16, 20, 35, 30}  // default running currents for all axes
#define TMC2130_CURRENTS_H {30, 30, 55, 38}
#define TMC2130_CURRENTS_R {30, 30, 55, 38}
...
#define FILAMENTCHANGE_XPOS 205
